...
//     p->tiempo_total); sleep(p->tiempo_total); // Simula tiempo de ejecución.
...
//             printf("Opción no válida. Por favor, ingrese un número entre 1
//             y 6.\n"); continue;
//         }
...
//                 // Crear hilos
//                 for (int i = 0; i < 4; i++) {
//                     if (cethread_create(&hilos[i], rutina, (void
//                     *)&procesos[i])) { // Instead of if
//                     (pthread_create(&hilos[i], NULL, rutina, (void
//                     *)&procesos[i])) {
//                         fprintf(stderr, "Error al crear el hilo %d\n", i);
//                         return 1;
//                     }
//                     // Esperar a que el hilo actual termine antes de crear el
//                     siguiente cethread_join(hilos[i], NULL); // Instead of
...
//             }
//             case 4: {
//                 //int quantum = leerEnteroPositivo("Ingrese el quantum para
//                 Round Robin: ");
...
//             }
//             case 5: {
//                 //int tiempo_max = leerEnteroPositivo("Ingrese el tiempo
//                 máximo para los hilos de tiempo real: ");
